...
if args.data == 'ssec':
    ...
    train_data.load(dictionary=Corpus_Dic, train_mode=True, tokenize=tokenize, level=args.level, label_select=args.label)
...
if args.embedding:
    # model.load_embedding('Emotional-Embedding/vectors/numberbatch-en.txt', Corpus_Dic, device)
    model.load_embedding('wiki-news-300d-1M-subword.vec.new', Corpus_Dic, device)
    # model.load_embedding('wiki-news-300d-1M-subword.vec.bak', Corpus_Dic, device)
