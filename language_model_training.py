...
parser.add_argument('--number_per_class', type=int, default=1000,
                    help='location of the data corpus')
parser.add_argument('--addition', type=str, default=False,
...
if args.data == 'ssec':
    ...
    train_data.load(dictionary=Corpus_Dic, train_mode=True, tokenize=args.tokenize, level=0, addition=args.addition)
...
optimizer = torch.optim.SGD(model.parameters(), lr=learning_rate, momentum=0.9) #Adam(model.parameters(), lr=learning_rate)
