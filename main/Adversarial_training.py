...
print(unlabeled_train_data.max_length)
# save the dictionary
if not dic_exists:
...
judger = judge.RNNModel(args.model, ntokens, args.emsize, args.nhid,
                        args.nlayers, args.nclass, args.dropout_em,
                        args.dropout_rnn, args.dropout_cl, args.tied, n_cl_hidden=30,
                        beta_size=max([
                            labeled_train_data.max_length,
                            unlabeled_train_data.max_length,
...
def train(epoch=None):
    ...
    # 2. pre_train judger and adv train.
        ...
        num_iter = max(len(unlabeled_train_data), len(labeled_train_data)) // args.batch_size
        start_time = time.time()
        total_judge_loss = 0
        total_unl_loss = 0
        total_lab_loss = 0
