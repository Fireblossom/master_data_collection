...
dataset0 = loader.load_ssec('data_collection/ssec-aggregated/train-combined-0.0.csv')
dataset3 = loader.load_ssec('data_collection/ssec-aggregated/train-combined-0.33.csv')
dataset5 = loader.load_ssec('data_collection/ssec-aggregated/train-combined-0.5.csv')
dataset6 = loader.load_ssec('data_collection/ssec-aggregated/train-combined-0.66.csv')
dataset9 = loader.load_ssec('data_collection/ssec-aggregated/train-combined-0.99.csv')
